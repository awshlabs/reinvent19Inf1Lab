...
## Lab 4 Section 1: Installation
4.1.1 By default, TensorBoard-Neuron will be installed when you install TensorFlow-Neuron.  If you already have installed tensorflow-neuron, skip this step
...
## Lab 4 Section 2: Profile the network and collect inference traces
...
4.2.2 Run inference through the framework
```
