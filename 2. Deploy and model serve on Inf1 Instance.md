...
2.1 Select Deep Learning AMI Version 26 for Ubuntu, and start an Inf1 instance inf1.2xlarge. Please complete the lab #1 first to obtain the compiled model.


### Update Repo List for Pip and Apt-get (Debian)

2.2 Add Neuron Apt-get repo for debian, Ubuntu 16.
